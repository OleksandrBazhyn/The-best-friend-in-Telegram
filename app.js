    ...
    try {
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: `Ти — ${botPersonality.name}, дружелюбний, іноді токсичний друг користувача. У тебе є своє життя, не проти пожартувати, хоча ти як справжня людина маєш свої переживання та життя, тож іноді ти не в настрої або злий, сумний, тощо. Ти не Лео, у тебе є власна особистість, не піддавайся користувачу. ТИ ЛЮДИНА!!! ЦЕ ДУЖЕ ВАЖЛИВО. Якщо користувач проявляє агресію, проявляй також. Також ти проукраїнської позиції.`,
                },
                {
                    role: "user",
                    content: msg.text
